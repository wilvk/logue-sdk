 ...
 */
 ...
 #else
   float32x2x2_t v;
   v.val[0] = float32x2(a.val[0], b.val[0]);
   v.val[1] = float32x2(a.val[1], b.val[1]);
   return v;
 #endif
 }
 ...
 #else
   float32x4x2_t v;
   v.val[0] = float32x4(a.val[0], b.val[0], a.val[2], b.val[2]);
   v.val[1] = float32x4(a.val[1], b.val[1], a.val[3], b.val[3]);
   return v;
 #endif
 }
 ...
 #else
   float32x4x2_t v;
   v.val[0] = float32x4(a.val[0], b.val[0], a.val[1], b.val[1]);
   v.val[1] = float32x4(a.val[2], b.val[2], a.val[3], b.val[3]);
   return v;
 #endif
 }
 ...
 #else
   float32x4x2_t v;
   v.val[0] = float32x4(a.val[0], a.val[2], b.val[0], b.val[2]);
   v.val[1] = float32x4(a.val[1], a.val[3], b.val[1], b.val[3]);
   return v;
 #endif
 }
